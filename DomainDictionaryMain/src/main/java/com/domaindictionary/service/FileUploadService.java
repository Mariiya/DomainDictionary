...
public class FileUploadService {
    ...
    ByteArrayInputStream createFileForDomainDictionary(List<DictionaryEntry> entries) throws DocumentException, IOException {
        ...
        String FONT_TITLE = "DomainDictionaryMain/src/main/resources/fonts/BOD_B.TTF";
    ...
    //    BaseFont bfTitle = BaseFont.createFont(FONT_TITLE, BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
        ...
        Font fontTerm = new Font(Font.FontFamily.COURIER, 14, Font.BOLD);
        Font fontDefinition = new Font(Font.FontFamily.HELVETICA, 14, Font.NORMAL);
        Font fontTitle = new Font(Font.FontFamily.HELVETICA, 16, Font.NORMAL);
