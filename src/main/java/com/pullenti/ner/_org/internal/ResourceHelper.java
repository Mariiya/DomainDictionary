...
public class ResourceHelper {
    ...
    public static byte[] getBytes(String name) {
        ...
        String[] names = com.pullenti.ner._org.internal.properties.Resources.getNames();
        for (String n : names) {
            if (com.pullenti.unisharp.Utils.endsWithString(n, name, true)) {
                ...
                try {
                    Object inf = com.pullenti.ner._org.internal.properties.Resources.getResourceInfo(n);
                    if (inf == null) 
                        continue;
                    try (com.pullenti.unisharp.Stream stream = com.pullenti.ner._org.internal.properties.Resources.getStream(n)) {
